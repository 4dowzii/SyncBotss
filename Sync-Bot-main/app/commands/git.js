...
module.exports = {
    ...
    async execute(client, message, args) {
        ...
        const yetkiliRoller = ["1276678531446865920", "1276933560070045717", "1276893418387406898","1277289157802328104","1276885280858701897"];
        ...
        if (message.member.hasPermission("ADMINISTRATOR")) { 
            await message.member.voice.setChannel(üye.voice.channelID), 
            message.lineReply('`Başarılı bir şekilde etiketlenen üyenin yanına gidildi.`')
            ...
            message.channel.send(new Discord.MessageEmbed()
                .setDescription(`${üye}, ${message.author} senin yanına gelmek istiyor. Kabul ediyormusun?`)
